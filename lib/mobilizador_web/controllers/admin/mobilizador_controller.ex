defmodule MobilizadorWeb.Admin.MobilizadorController do
  ...
  def create(conn, %{"user" => user_params}) do
    case Pow.Ecto.Context.create(user_params |> Map.put("kind", "mobilizador"), [user: Mobilizador.Users.User, repo: Mobilizador.Repo ]) do
      {:ok, user} ->
        ...
        |> redirect(to: Routes.mobilizador_path(conn, :show, user))
  ...
  def delete(conn, %{"id" => id}) do
    ...
    |> redirect(to: Routes.mobilizador_path(conn, :index))
  end
end
