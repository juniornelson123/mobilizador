defmodule MobilizadorWeb.Mobilizador.LeadController do
  ...
  def create(conn, %{"lead" => lead_params}) do
    ...
    case Attendance.create_lead(lead_params |> Map.put("user_id", Pow.Plug.current_user(conn).id)) do
      {:ok, lead} ->
        ...
        |> redirect(to: Routes.mobilizador_lead_path(conn, :show, lead))
  ...
  def delete(conn, %{"id" => id}) do
    ...
    |> redirect(to: Routes.mobilizador_lead_path(conn, :index))
  end
end
